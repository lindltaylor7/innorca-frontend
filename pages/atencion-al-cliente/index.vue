											...
											<div>
												<select
													...
													<option
														...
														<span v-if="!questionCategory.subcategories"
															>&nbsp;&nbsp;&nbsp;</span
														>
									...
									<div class="table">
										...
										<template v-if="tickets.length > 0">
											...
											<div v-if="nextMoreTickets" class="text-center mt-3">
												<div @click="fetchMoreTickets()" style="cursor: pointer">
													<span class="see-more" :class="{ loading: loadingFetchMoreTickets }"
														>VER MÁS</span
													>
												</div>
											</div>
										...
										<template v-else>
											<div class="text-center">
												<strong style="font-size: 16px" v-if="titular === 'titular'"
													>Aún no has generado ninguna solicitud</strong
												>
		...
		computed: {
			...
			questionCategoriesOptions() {
				...
				this.questionCategories.forEach((category) => {
					if (category.name == 'Atención al cliente') this.filter.form.category = category;
